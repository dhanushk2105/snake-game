...
function KeyPad({ direction, setDirection }) {
    return (
        <div className='flex flex-col md:hidden w-full justify-center py-5'>
            ...
            <button className='w-10 h-10 flex justify-center items-center aspect-square rounded-xl border-white border-spacing-2 text-white'>
            </button>
            <button onClick={() => {
                direction.y !== -1 ? setDirection({ x: 0, y: 1 }) : null
            }}
